...
public class DetailActivity extends YouTubeBaseActivity {
    ...
    private static final String YOUTUBE_API_KEY = "AIzaSyCq5RSPfYRzJ9MtaARjUi6eUUdtsutJKos";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("Detail", "Rating: " + movie.getRating() + " casted: " + (float)movie.getRating());
    ...
    private void initializeYoutube(String youtubeKey, double rating) {
        youtubePlayerView.initialize(YOUTUBE_API_KEY, new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationFailure(YouTubePlayer.Provider provider, YouTubeInitializationResult youTubeInitializationResult) {
                Log.d("Detail","onInitializationFailure");
            }
        });
    }
}